...
This is the **img-src Go SDK** (`github.com/img-src-io/sdk-go`). The code was originally bootstrapped from the OpenAPI spec at `api/openapi.json` in the parent monorepo and is now maintained manually — edit files directly. The per-file "Code generated by Speakeasy" headers are historical and not enforced.
