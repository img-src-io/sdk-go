...
func newUsage(rootSDK *Imgsrc, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Usage {
	return &Usage{
		rootSDK:          rootSDK,
...
func (s *Usage) GetUsage(ctx context.Context, opts ...operations.Option) (*operations.GetUsageResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v1/usage")
	if err != nil {
