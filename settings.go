...
func (s *Settings) UpdateSettings(ctx context.Context, request *components.UpdateSettingsRequest, opts ...operations.Option) (*operations.UpdateSettingsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
