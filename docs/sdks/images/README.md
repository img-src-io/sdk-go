...
func main() {
    ...
    res, err := s.Images.UploadImage(ctx, &operations.UploadImageRequestBody{
...
func main() {
    ...
    res, err := s.Images.ListImages(ctx, sdkgo.Pointer[int64](50), optionalnullable.From(sdkgo.Pointer[int64](0)), nil)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Images.SearchImages(ctx, "<value>", sdkgo.Pointer[int64](20))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Images.GetImage(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Images.DeleteImage(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Images.CreateSignedURL(ctx, "<id>", &components.CreateSignedURLRequest{})
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Images.DeleteImagePath(ctx, "Destiney35", "/etc/rightfully.mp3")
    if err != nil {
        log.Fatal(err)
    }
