...
func main() {
    ...
    res, err := s.Images.SearchImages(ctx, "vacation", sdkgo.Pointer[int64](20))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Images.DeleteImage(ctx, "abcdef1234567890")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Images.DeleteImagePath(ctx, "johndoe", "blog/2024/photo.webp")
    if err != nil {
        log.Fatal(err)
    }
